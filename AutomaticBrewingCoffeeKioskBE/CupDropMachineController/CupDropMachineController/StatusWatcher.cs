...
namespace CupDropMachineController
{
    ...
    {
        private readonly CupDroppingMachine _machine;
        ...
        public StatusWatcher(CupDroppingMachine machine, string deviceId, IRabbitMqPublisher<UpdateStatusStepMsg> publisher, IRabbitMqPublisher<DeviceLabelMessage> deviceLabelMsgPublisher)
        {
        ...
        private async Task DoWork()
        {
            ...
            try
            {
                ...
                var labels = CupDroppingMachine.GetLabels();
        ...
        private void WriteData(SlaveStatusCommand statusQuery)
        {
            ...
            _deviceStatus[nameof(SlaveStatusCommand.Data2Bit.CurrentSystemStatus)] = statusQuery.Data2.CurrentSystemStatus.ToString();
        }
