...
namespace fairino
{
    public class Robot
    {
        ...
        //private Socket sock_cli_cmd; // Giao tiếp gửi/nhận lệnh thời gian thực
        //private Socket sock_cli_state; // Giao tiếp phản hồi trạng thái thời gian thực
        ...
        #region Thông số max/min xoay tròn của 6 khớp
        //-174.99, -264.99, -160, -264.99, -174.99, -174.99
        //175.504, 84.504, 159.71, 84.504, 174.504, 174.504
        //Safe rotation on kiosk
        private double[] jointMin = new double[6] { -170, -189.975, -160, -264.99, -170, -170 };
        private double[] jointMax = new double[6] { 170, 8, -189.975, 84.504, 170, 170 };
        ...
        // Trạng thái kết nối lại: false - chưa kết nối lại, true - đã kết nối lại
        ...
        */
        ...
        /**
          * @brief Điều khiển chuyển đổi giữa chế độ tự động và thủ công của robot
          * @param [in] mode 0 - chế độ automation, 1 - chế độ mannual
          * @return Mã lỗi
          */
        ...
        /**
 * @brief  Điều khiển robot vào hoặc thoát chế độ kéo dạy (drag teach mode)
 * @param  [in] state 0 - thoát chế độ DragTeach, 1 - vào chế độ  DragTeach
 * @return  Mã lỗi
 */
        ...
        /**
         * @brief  Điều khiển bật hoặc tắt chế độ có hiệu lực (enable) của robot. 
         *         Sau khi robot được cấp điện, mặc định sẽ tự động bật chế độ có hiệu lực.
         * @param  [in] state  0 - Tắt chế độ enable, 1 - Bật chế độ enable
         * @return  Mã lỗi (nếu có)
         */
        ...
        /**
   * @brief  Bắt đầu bảo vệ tư thế kỳ dị (Singularity Protection)
   * @param  [in] protectMode  Chế độ bảo vệ kỳ dị, 0: chế độ khớp; 1: chế độ tọa độ Đề-các
   * @param  [in] minShoulderPos  Ngưỡng điều chỉnh kỳ dị tại vai (mm), mặc định 100
   * @param  [in] minElbowPos     Ngưỡng điều chỉnh kỳ dị tại khuỷu tay (mm), mặc định 50
   * @param  [in] minWristPos     Ngưỡng điều chỉnh kỳ dị tại cổ tay (độ), mặc định 10
   * @return Mã lỗi
   */
        ...
        /**
         * @brief  Dừng bảo vệ tư thế kỳ dị (Singularity Protection)
         * @return Mã lỗi
         */
        ...
        /**
         * @brief  Jog (điều khiển điểm động) của robot
         * @param  [in]  refType Kiểu hệ tọa độ:
         *                       0 - Điểm động theo khớp (joint),
         *                       2 - Theo hệ tọa độ cơ sở (base),
         *                       4 - Theo hệ tọa độ dụng cụ (tool),
         *                       8 - Theo hệ tọa độ chi tiết (workpiece)
         * @param  [in]  nb Chỉ số trục hoặc khớp:
         *                  1 - Khớp 1 (hoặc trục X),
         *                  2 - Khớp 2 (hoặc trục Y),
         *                  3 - Khớp 3 (hoặc trục Z),
         *                  4 - Khớp 4 (hoặc quay quanh trục X),
         *                  5 - Khớp 5 (hoặc quay quanh trục Y),
         *                  6 - Khớp 6 (hoặc quay quanh trục Z)
         * @param  [in]  dir Hướng di chuyển:
         *                  0 - Hướng âm,
         *                  1 - Hướng dương
         * @param  [in]  vel Tốc độ (theo phần trăm), trong khoảng [0 ~ 100]
         * @param  [in]  acc Gia tốc (theo phần trăm), trong khoảng [0 ~ 100]
         * @param  [in]  max_dis Góc quay tối đa hoặc khoảng cách tối đa cho một lần điểm động,
         *                       đơn vị: độ (°) hoặc mm (tùy thuộc vào chế độ)
         * @return Mã lỗi (nếu có)
         */
        ...
        /**
         * @brief  Dừng chuyển động jog (điểm động) bằng cách giảm tốc
         * @param  [in]  stopType Kiểu dừng tương ứng với hệ tọa độ:
         *                        1 - Dừng điểm động theo khớp (joint),
         *                        3 - Dừng điểm động theo hệ tọa độ cơ sở (base),
         *                        5 - Dừng điểm động theo hệ tọa độ dụng cụ (tool),
         *                        9 - Dừng điểm động theo hệ tọa độ chi tiết (workpiece)
         * @return Mã lỗi (nếu có)
        */
        ...
        /**
         * @brief  Dừng ngay lập tức chuyển động jog (điểm động)
         * @return Mã lỗi (nếu có)
         */
        ...
        /**
  * @brief  Chuyển động trong không gian khớp (Joint space motion)
  * @param  [in] int_pos      Vị trí khớp mục tiêu, đơn vị: độ (deg)
  * @param  [in] desc_pos     Vị trí và tư thế mục tiêu trong không gian Descartes
  * @param  [in] tool         Số hiệu hệ tọa độ công cụ, phạm vi [0~14]a
  * @param  [in] user         Số hiệu hệ tọa độ chi tiết gia công, phạm vi [0~14]
  * @param  [in] vel          Tốc độ theo phần trăm, phạm vi [0~100]
  * @param  [in] acc          Gia tốc theo phần trăm, phạm vi [0~100], hiện chưa hỗ trợ
  * @param  [in] ovl          Hệ số co giãn tốc độ, phạm vi [0~100]
  * @param  [in] epos         Vị trí trục mở rộng, đơn vị: mm
  * @param  [in] blendT       [-1.0] - di chuyển đến vị trí (chặn), [0~500.0] - thời gian làm mượt (không chặn), đơn vị: ms
  * @param  [in] offset_flag  0 - không dịch chuyển, 1 - dịch chuyển theo hệ tọa độ cơ sở hoặc chi tiết, 2 - dịch chuyển theo hệ tọa độ công cụ
  * @param  [in] offset_pos   Giá trị dịch chuyển vị trí và tư thế
  * @return Mã lỗi
  */
        ...
        /**
   * @brief Bắt đầu chuyển động servo, sử dụng kết hợp với lệnh ServoJ, ServoCart
   * @return Mã lỗi
   */
        ...
        /**
 * @brief  Chuyển động điểm đến điểm (PTP) trong không gian Cartesian
 * @param  [in]  desc_pos  Vị trí mục tiêu trong không gian Cartesian hoặc tăng vị trí
 * @param  [in] tool  Số hiệu hệ tọa độ công cụ, phạm vi [0~14]
 * @param  [in] user  Số hiệu hệ tọa độ chi tiết gia công, phạm vi [0~14]
 * @param  [in] vel  Tỷ lệ phần trăm tốc độ, phạm vi [0~100]
 * @param  [in] acc  Tỷ lệ phần trăm gia tốc, phạm vi [0~100], hiện chưa mở
 * @param  [in] ovl  Hệ số tỷ lệ tốc độ, phạm vi [0~100]
 * @param  [in] blendT [-1.0] - chuyển động tới vị trí (chặn), [0~500.0] - thời gian làm mượt (không chặn), đơn vị ms
 * @param  [in] config  Cấu hình không gian khớp, [-1] - tham chiếu tính toán dựa trên vị trí khớp hiện tại, [0~7] - tham chiếu cấu hình không gian khớp cụ thể, mặc định là -1
 * @return  Mã lỗi
 */
        ...
        /**
  * @brief  Bắt đầu dịch chuyển toàn bộ các điểm dạy (Teach Points)
  * @param  [in] flag  0 - Dịch chuyển theo hệ tọa độ cơ sở hoặc hệ tọa độ chi tiết; 2 - Dịch chuyển theo hệ tọa độ dụng cụ
  * @param  [in] offset_pos  Lượng dịch chuyển vị thế (x, y, z, rx, ry, rz)
  * @return Mã lỗi
  */
        ...
        /**
  * @brief  Kết thúc dịch chuyển toàn bộ các điểm dạy (Teach Points)
  * @return Mã lỗi
  */
        ...
        /**
   * @brief  Thiết lập đầu ra tín hiệu số của hộp điều khiển
   * @param  [in] id        Mã số IO, phạm vi [0~15]
   * @param  [in] status    0 - Tắt, 1 - Bật
   * @param  [in] smooth    0 - Không làm mượt, 1 - Làm mượt
   * @param  [in] block     0 - Đồng bộ (chặn), 1 - Bất đồng bộ (không chặn)
   * @return Mã lỗi
   */
        ...
        /**
  * @brief  Thiết lập danh sách hệ tọa độ công cụ
  * @param  [in] id Số hiệu hệ tọa độ, phạm vi [1~15]
  * @param  [in] coord  Vị trí và hướng của tâm công cụ so với tâm mặt bích ở đầu robot
  * @param  [in] type  0 - Hệ tọa độ công cụ, 1 - Hệ tọa độ cảm biến
  * @param  [in] install Vị trí lắp đặt, 0 - Cuối cánh tay robot, 1 - Bên ngoài robot
  * @param  [in] loadNum Số hiệu tải trọng
  * @return  Mã lỗi
  */
        ...
        /**
  * @brief Thiết lập cấp độ va chạm
  * @param [in] mode 0 - theo cấp độ; 1 - theo phần trăm
  * @param [in] level Ngưỡng va chạm, phạm vi ứng với cấp độ [], phạm vi ứng với phần trăm [0~1],level 1 is the most
sensitive
  * @param [in] config 0 - không cập nhật file cấu hình; 1 - cập nhật file cấu hình
  * @return Mã lỗi
  */
        ...
        /**
 * @brief Thiết lập chiến lược sau khi va chạm
 * @param [in] strategy 
     * 0: Tạm dừng do lỗi  
    1: Tiếp tục chạy  
    2: Dừng do lỗi  
    3: Chế độ trọng lực  
    4: Chế độ phản hồi dao động  
    5: Chế độ bật lại khi va chạm
 * @param [in] safeTime Thời gian dừng an toàn [1000 - 2000] ms
 * @param [in] safeDistance Khoảng cách dừng an toàn [1 - 150] mm
 * @param [in] safeVel Tốc độ dừng an toàn của TCP [50 - 250] mm/s
 * @param [in] safetyMargin Hệ số an toàn cho các khớp j1 đến j6 [1 - 10]
 * @return Mã lỗi
 */
      ...
      */
        ...
        /**
  * @brief Công tắc bật/tắt bù ma sát cho các khớp
  * @param [in] state 0 - Tắt, 1 - Bật
  * @return Mã lỗi
  */
        ...
        /**
    * @brief Thiết lập hệ số bù ma sát cho các khớp - lắp đặt xuôi
    * @param [in] coeff Hệ số bù cho sáu khớp, phạm vi [0~1]
    * @return Mã lỗi
    */
        ...
        /**
   * @brief  Lấy vị trí hiện tại của các khớp (đơn vị: độ)
   * @param  [in] flag 0 - chặn (đợi kết quả), 1 - không chặn (trả về ngay)
   * @param  [out] jPos Vị trí của 6 khớp, đơn vị: độ (deg)
   * @return  Mã lỗi
*/
        ...
        /**
  * @brief Lấy gia tốc phản hồi của các khớp - đơn vị deg/s^2
  * @param [in] flag 0 - chặn (blocking), 1 - không chặn (non-blocking)
  * @param [out] acc Gia tốc của sáu khớp
  * @return Mã lỗi
  */
        ...
        /**
         * @brief  Lấy tốc độ phản hồi TCP
         * @param  [in] flag 0 - Đồng bộ (blocking), 1 - Không đồng bộ (non-blocking)
         * @param  [out] speed Mảng tốc độ [x, y, z, rx, ry, rz]
         * @return  Mã lỗi
         */
        ...
        /**
       * @brief  Giải bài toán nghịch động học (Inverse Kinematics) từ x,y,z,rx,ry,rz ra 6 joint để sử dụng moveJ di chuyển
       * @param  [in] type Kiểu tọa độ đầu vào:
       *                  0 - tọa độ tuyệt đối (trong hệ tọa độ cơ sở),
       *                  1 - tọa độ tăng dần (so với hệ tọa độ cơ sở),
       *                  2 - tọa độ tăng dần (so với hệ tọa độ công cụ)
       * @param  [in] desc_pos Tọa độ vị trí trong không gian Descartes (x, y, z, rx, ry, rz)
       * @param  [in] config Cấu hình không gian khớp:
       *                    -1 - giải dựa theo vị trí khớp hiện tại,
       *                    0~7 - giải dựa theo cấu hình khớp cụ thể đã chọn
       * @param  [out] joint_pos Vị trí các khớp sau khi tính toán (j1~j6)
       ...
       */
        ...
        /**
         * @brief  Giải bài toán nghịch động học, tham chiếu theo vị trí khớp đã cho
         * @param  [in] posMode       0 - Vị trí tuyệt đối,  
         *                            1 - Vị trí tương đối theo hệ tọa độ gốc,  
         *                            2 - Vị trí tương đối theo hệ tọa độ công cụ
         * @param  [in] desc_pos      Vị trí/tư thế trong không gian Descartes
         * @param  [in] joint_pos_ref Vị trí các khớp tham chiếu, tham chiếu để tối ưu cách di chuyển theo ý
         * @param  [out] joint_pos    Vị trí các khớp kết quả sau khi giải
         * @return Mã lỗi
         */
        ...
        public int GetInverseKinRef(int posMode, DescPose desc_pos, JointPos joint_pos_ref, ref JointPos joint_pos)
        {
            ...
            catch
            {
                ...
                /**
          * @brief  Giải bài toán nghịch động học, kiểm tra xem có nghiệm hay không dựa trên vị trí khớp tham chiếu
          * @param  [in] posMode 
          *         0 - tọa độ tuyệt đối,  
          *         1 - tọa độ tương đối so với hệ tọa độ cơ sở,  
          *         2 - tọa độ tương đối so với hệ tọa độ công cụ
          * @param  [in] desc_pos Vị trí trong không gian Descartes (x, y, z, rx, ry, rz)
          * @param  [in] joint_pos_参考关节位置 Vị trí khớp tham chiếu (dùng để hỗ trợ giải)
          * @param  [out] hasResult 
          *         0 - không có nghiệm (không tìm được vị trí khớp phù hợp),  
          *         1 - có nghiệm
          * @return Mã lỗi (0 nếu thành công)
          */
        ...
        /**
         * @brief  Giải bài toán động học thuận (Forward kinematics)
         * @param  [in] joint_pos   Vị trí các khớp
         * @param  [out] desc_pos   Tư thế trong không gian Descartes (tọa độ và hướng)
         * @return  Mã lỗi
         */
        ...
        /**
         * @brief  Lấy góc giới hạn mềm của các khớp
         * @param  [in] flag       0 - Đồng bộ (chờ kết quả), 1 - Không đồng bộ (không chờ)
         * @param  [out] negative  Góc giới hạn âm của từng khớp, đơn vị độ (deg)
         * @param  [out] positive  Góc giới hạn dương của từng khớp, đơn vị độ (deg)
         * @return Mã lỗi
         */
        ...
        /**
        * @brief  Lấy cấu hình không gian khớp hiện tại của robot
        * @param  [out] config  Cấu hình không gian khớp, phạm vi [0~7]
        * @return Mã lỗi
        */
        ...
        /**
         * @brief  Lấy tốc độ mặc định của robot
         * @param  [out] vel  Tốc độ, đơn vị mm/s
         * @return  Mã lỗi
         */
        ...
        /**
   * @brief  Kiểm tra robot đã hoàn thành chuyển động hay chưa
   * @param  [out]  state  0 - Chưa hoàn thành, 1 - Đã hoàn thành
   * @return  Mã lỗi
   */
        ...
        /**
    * @brief  Truy vấn mã lỗi của robot
    * @param  [out]  maincode  Mã lỗi chính
    * @param  [out]  subcode   Mã lỗi phụ
    * @return  Mã lỗi
    */
        ...
        /**
          * @brief  Truy vấn dữ liệu điểm dạy (point) của robot trong quản lý điểm dạy
          * @param  [in]   name   Tên điểm dạy
          * @param  [out]  data   Dữ liệu điểm dạy (mảng double[20] gồm: 
          *                       x, y, z, rx, ry, rz, j1, j2, j3, j4, j5, j6, 
          *                       tool, wobj, speed, acc, e1, e2, e3, e4)
          * @return  Mã lỗi
          */
        ...
        /**
   * @brief  Thiết lập tham số ghi lại quỹ đạo
   * @param  [in] type  Loại dữ liệu cần ghi, 1 - Vị trí khớp
   * @param  [in] name  Tên file ghi quỹ đạo
   * @param  [in] period_ms  Chu kỳ lấy mẫu dữ liệu, giá trị cố định: 2ms, 4ms hoặc 8ms
   * @param  [in] di_choose  Lựa chọn DI, bit0~bit7 tương ứng với DI0~DI7 của hộp điều khiển, bit8~bit9 tương ứng với DI0~DI1 của đầu cuối; 0 - không chọn, 1 - chọn
   * @param  [in] do_choose  Lựa chọn DO, bit0~bit7 tương ứng với DO0~DO7 của hộp điều khiển, bit8~bit9 tương ứng với DO0~DO1 của đầu cuối; 0 - không chọn, 1 - chọn
   * @return  Mã lỗi
*/
        ...
        /**
  * @brief  Bắt đầu ghi lại quỹ đạo
  * @param  [in] type  Loại dữ liệu ghi lại, 1 - vị trí các khớp
  * @param  [in] name  Tên file quỹ đạo
  * @param  [in] period_ms  Chu kỳ lấy mẫu dữ liệu, giá trị cố định 2ms hoặc 4ms hoặc 8ms
  * @param  [in] di_choose  Lựa chọn DI, bit0~bit7 tương ứng với DI0~DI7 của hộp điều khiển, bit8~bit9 tương ứng với DI0~DI1 của đầu cuối, 0 - không chọn, 1 - chọn
  * @param  [in] do_choose  Lựa chọn DO, bit0~bit7 tương ứng với DO0~DO7 của hộp điều khiển, bit8~bit9 tương ứng với DO0~DO1 của đầu cuối, 0 - không chọn, 1 - chọn
  * @return  Mã lỗi
  */
      ...
      */
        ...
        /**
         * @brief  Lấy vị trí và姿态 (pose) bắt đầu của quỹ đạo
         * @param  [in] name Tên file quỹ đạo, không cần phần mở rộng (file suffix)
         * @return  Mã lỗi
         */
        ...
        /**
            * @brief  Tái hiện (phục hồi) đường chạy (quỹ đạo)
            * @param  [in] name  Tên file đường chạy
            * @param  [in] blend 0 - không làm mượt, 1 - làm mượt
            * @param  [in] ovl  Tỷ lệ phần trăm tỉ lệ tốc độ, phạm vi [0~100]
            * @return  Mã lỗi
            */
        ...
        /**
  * @brief  Xử lý trước quỹ đạo
  * @param  [in] name  Tên tập tin quỹ đạo
  * @param  [in] ovl   Tỷ lệ thu nhỏ tốc độ, phạm vi [0~100]%
  * @param  [in] opt   1 - điểm điều khiển, mặc định là 1
  * @return Mã lỗi
  */
        ...
        /**
          * @brief  Thiết lập tốc độ khi đang chạy quỹ đạo
          * @param  [in] ovl Tỷ lệ phần trăm tốc độ
          * @return  Mã lỗi
        */
        ...
        /**
   * @brief Kích hoạt kẹp (gripper)
   * @param [in] index Mã số kẹp
   * @param [in] act 0 - Đặt lại, 1 - Kích hoạt
   * @return Mã lỗi
   */
        ...
        */
        ...
        /**
          * @brief  Bảo vệ va chạm - Kiểm tra va chạm ở các khớp (joint) chỉ định
          * @param  [in] flag 0 - Tắt chế độ bảo vệ va chạm, 1 - Bật chế độ bảo vệ va chạm
          * @param  [in] sensor_id Mã số cảm biến lực
          * @param  [in] select  Chọn xem có kiểm tra va chạm ở 6 bậc tự do hay không, 0 - không kiểm tra, 1 - kiểm tra
          * @param  [in] ft  Giá trị lực/mô-men chuẩn để so sánh va chạm: fx, fy, fz, tx, ty, tz
          * @param  [in] max_threshold Ngưỡng tối đa cho mỗi thành phần
          * @param  [in] min_threshold Ngưỡng tối thiểu cho mỗi thành phần
          * @note   Phạm vi phát hiện lực/mô-men: (ft - min_threshold, ft + max_threshold)
          * @return Mã lỗi
          */
  ...
  */
        ...
        /**
         * @brief  Lấy tín hiệu dừng an toàn
         * @param [out]  si0_state  Tín hiệu dừng an toàn SI0, 0 - không hiệu lực, 1 - có hiệu lực
         * @param [out]  si1_state  Tín hiệu dừng an toàn SI1, 0 - không hiệu lực, 1 - có hiệu lực
         */
        ...
        */
        ...
        /** 
  * @brief Xóa thông tin lỗi của trục mở rộng 485
  * @param [in] servoId ID của bộ điều khiển servo, trong khoảng [1-16], tương ứng với ID của slave
  * @return Mã lỗi 
  */
        ...
        */
        ...
        /**
           * @brief Bắt đầu điều khiển điểm động mở rộng trục UDP
           * @param [in] axisID Số trục [1-4]
           * @param [in] direction Hướng quay 0 - ngược chiều; 1 - thuận chiều
           * @param [in] vel Vận tốc (mm/s)
           * @param [in] acc Gia tốc (mm/s²)
           * @param [in] maxDistance Khoảng cách điểm động tối đa
           * @return Mã lỗi
        */
        ...
        */
        ...
        /**
  * @brief Thiết lập phương pháp phát hiện va chạm cho robot
  * @param [in] method Phương pháp phát hiện va chạm: 0 - chế độ dòng điện; 1 - mã hóa kép; 2 - đồng thời dùng dòng điện và mã hóa kép
  * @return Mã lỗi
  */
        ...
        /**
  * @brief Thiết lập trạng thái phát hiện va chạm khi đứng yên (tĩnh)
  * @param  [in] status 0 - Tắt; 1 - Bật
  * @return Mã lỗi
  */
   ...
   */
        ...
        */
        ...
        /**
   * @brief Bắt đầu chức năng ngưỡng phát hiện va chạm tùy chỉnh, thiết lập ngưỡng phát hiện va chạm cho khớp và đầu TCP
   * @param [in] flag 1 - chỉ bật phát hiện va chạm khớp; 2 - chỉ bật phát hiện va chạm TCP; 3 - bật đồng thời phát hiện va chạm khớp và TCP
   * @param [in] jointDetectionThreshould Ngưỡng phát hiện va chạm khớp cho các khớp j1 đến j6
   * @param [in] tcpDetectionThreshould Ngưỡng phát hiện va chạm TCP cho các trục xyzabc
   * @param [in] block 0 - không chặn (non-blocking); 1 - chặn (blocking)
   * @return Mã lỗi
   */
        ...
        /**
    * @brief Tắt chức năng ngưỡng phát hiện va chạm tùy chỉnh
    * @return Mã lỗi
    */
      ...
      */
        ...
        */
        ...
        /**
   * @brief Lấy mã SN của hộp điều khiển
   * @param [out] SNCode Mã SN của hộp điều khiển
   * @return Mã lỗi
   */
        ...
        /**
         * LỖI: Control box không có hàm này
  * @brief Tắt hệ điều hành của robot
  * @return Mã lỗi
  */
        ...
        public int ShutDownRobotOS()
        {
            ...
            try
            {
                // Gọi phương thức từ xa "ShutDownRobotOS"
            ...
            {
                // Bắt ngoại lệ, ghi lại nhật ký (tuỳ chọn)
                // Trả về mã lỗi đã định nghĩa trước
                return (int)RobotError.ERR_RPC_ERROR;
            }
        }
        /**
         * @brief Kiểm tra tín hiệu đầu vào của băng chuyền thông qua giao tiếp
         * @param [in] timeout Thời gian chờ tối đa (đơn vị: mili giây)
         * @return Mã lỗi
         */
        ...
        /**
    * @brief Kích hoạt kiểm tra tín hiệu đầu vào giao tiếp của băng chuyền
    * @return Mã lỗi
    */
