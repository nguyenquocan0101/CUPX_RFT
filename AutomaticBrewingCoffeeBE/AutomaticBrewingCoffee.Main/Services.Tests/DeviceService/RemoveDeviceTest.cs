...
public class RemoveDeviceTest(StartUpTestBase fixture) : IAsyncLifetime
{
    ...
    {
        _deviceTest = await TestDataRemoveDevice.CreateDeviceTest(_dbContext);
    }

    public async Task DisposeAsync() => await _resetDatabase();

    [Fact]
    public async Task Handle_RemoveDeviceWithCorrectRequest_ReturnsCorrectResponse()
    {
        // Arrange
        _deviceTest = await TestDataRemoveDevice.CreateDeviceTest(_dbContext);
        var deviceId = _deviceTest.DeviceId;
        var service = _deviceService.RemoveDevice(deviceId);
    ...
    [Fact]
    public async Task Handle_RemoveDeviceWithIncorrectRequest_ReturnsCorrectResponse()
    {
        // Arrange
